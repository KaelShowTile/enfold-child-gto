...
?>
<div id="reviews" class="woocommerce-Reviews gto-review-container">
	<div id="comments" class="gto-review-list av_one_half el_before_av_one_half">
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		<div id="review_form_wrapper" class="gto-review-form av_one_half  el_after_av_one_half">
