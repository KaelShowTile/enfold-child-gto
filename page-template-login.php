				...
				<main class='template-page content  <?php avia_layout_class( 'content' ); ?> units <?php echo $main_class; ?>' <?php avia_markup_helper(array('context' => 'content','post_type'=>'page'));?>>
					...
					*/
					...
					{?>
						...
						<div class="container Google-login-container">

							<a href="/gto-login/?loginSocial=google" data-plugin="nsl" data-action="connect" data-redirect="current" data-provider="google" data-popupwidth="600" data-popupheight="600">
								<img src="/wp-content/uploads/2025/03/google-login-icon.svg" alt="login with Google" />
							</a>
