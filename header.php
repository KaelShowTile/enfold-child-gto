...
<body id="top" <?php body_class( $body_classes ); avia_markup_helper( array( 'context' => 'body' ) ); ?>>
	...
	<?php
		...
		if ($submenu_page) {
			...
			$subscribe_shortcode = "[av_mailchimp list='97943a0c10' double_opt_in='aviaTBdouble_opt_in' on_send='' sent='Thank you for subscribing to our newsletter!' link='manually,https://' color='' hide_labels='aviaTBhide_labels' alb_description='' id='mega-menu-newsletter' custom_class='' template_class='' av_uid='av-mhebol97' sc_version='1.0'][av_mailchimp_field id='0' label='E-Mail:' type='text' value='' disabled='' check='is_email' av_uid='av-2jw9wbp'][av_mailchimp_field id='1' type='text' check='' options='' disabled='aviaTBaviaTBdisabled' label='First Name' width='' av_uid='av-mhebmrpq' sc_version='1.0'][av_mailchimp_field id='2' type='text' check='' options='' disabled='aviaTBaviaTBdisabled' label='Last Name' width='' av_uid='av-mhebmuh4' sc_version='1.0'][av_mailchimp_field id='3' label='Address' type='address' value='' disabled='true' check='' av_uid='av-7dwv39'][av_mailchimp_field id='4' label='Phone Number' type='phone' value='' disabled='true' check='' av_uid='av-1kt6sg5'][av_mailchimp_field id='5' type='birthday' check='' options='' disabled='aviaTBaviaTBdisabled' label='Birthday' width='' av_uid='av-mhebn042' sc_version='1.0'][av_mailchimp_field id='6' label='Company' type='text' value='' disabled='true' check='' av_uid='av-1bkjwrp'][av_mailchimp_field id='av-button' label='Subscribe' type='button' value='' check='' av_uid='av-rcrmw5'][/av_mailchimp]";
			?>

			<div id="gto-mega-menu-container">
				...
				<div class="mega-menu-bottom-container">
					...
					<div class="flex_column av_three_fifth flex_column_div newsletter-container">
						...
						<div class="flex_column av_one_half el_after_av_one_halfavia-builder-el-last flex_column_div">
